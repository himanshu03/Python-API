...
def test_Worklist_13(Authorization, Base_Url, set_cookie):
    ...
    try:
        ...
        url_1 = Base_Url + test_data['test_care'] + project_data[conftest.cmd_arg]["test_13"]["uri1"] + ids[
            0] + "/message"
        print(url_1)
...
def test_Worklist_15(Authorization, Base_Url, set_cookie):
    ...
    try:
        ...
        url_1 = Base_Url + test_data['test_care'] + project_data[conftest.cmd_arg]["test_15"]['uri1'] + ids[
            0] + "/_accept"
        print(url_1)
...
def test_Worklist_16(Authorization, Base_Url, set_cookie):
    ...
    try:
        ...
        url_1 = Base_Url + test_data['test_care'] + project_data[conftest.cmd_arg]["test_16"]["uri1"] + ids[
            0] + "/_decline"
        print(url_1)
